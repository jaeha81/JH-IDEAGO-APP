...
class AgentResponse(Base):
    ...
    # query_id groups all agent responses from a single POST /agents/query call
    query_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False, index=True)
